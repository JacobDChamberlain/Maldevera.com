    ...
    return (
        <div className="at-controls">
            <div className='at-controls-left'>
                <button className='btn at-player-stop disabled'>
                    <FontAwesomeIcon icon={faStepBackward} />
                </button>
                <button onClick={() => playPause()} className='btn at-player-play-pause disabled'>
            ...
            <div className="at-controls-right">
                    <button className={`btn toggle at-count-in ${ countIn ? 'active' : ''}`}
                        onClick={toggleCountIn}>
                        <FontAwesomeIcon className='fa' icon={faHourglassHalf} />
                    </button>
                    <button className={`btn at-metronome ${ metronome ? 'active' : ''}`}
                        onClick={toggleMetronome}>
                        <FontAwesomeIcon className='fa' icon={faUserClock} />
                    </button>
                    <button className={`btn at-loop ${ isLooping ? 'active' : ''}`}
                        onClick={toggleLoop}>
                        <FontAwesomeIcon className='fa' icon={faRetweet} />
                    </button>
                    <button className="btn at-print" onClick={handlePrint}>
